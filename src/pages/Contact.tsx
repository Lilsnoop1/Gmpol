...
const Contact: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setSubmitStatus({
        type: 'success',
        message: t('message_sent_success', 'Your message has been sent successfully! We will get back to you soon.')
      });
      setFormData({
        name: '',
        email: '',
      ...
      setSubmitStatus({
        type: 'error',
        message: t('message_send_failed', 'Failed to send your message. Please try again later.')
      });
    } finally {
      ...
      <section className="relative bg-blue-700 py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl font-bold text-white mb-4">{t('contact_us', 'Contact Us')}</h1>
            <p className="text-xl text-blue-100 max-w-3xl mx-auto">
              {t('contact_description', 'Get in touch with our team of medical equipment experts. We\'re here to help you find the right solutions.')}
            </p>
          </div>
        </div>
            ...
            <div>
              ...
              <div className="bg-gray-50 rounded-lg p-6 mb-6">
                <div className="space-y-6">
                  <div className="flex items-start">
                    ...
                    <div className="ml-4">
                      <h3 className="text-lg font-medium text-gray-900">
                        {t('karachi_office', 'Karachi Office')}
                      </h3>
                      <div>
                        <p className="text-gray-600">{t('karachi_address_line1', '18-C 24th Commercial Street')}</p>
                        <p className="text-gray-600">{t('karachi_address_line2', 'Phase-II, (EXT) DHA')}</p>
                        <p className="text-gray-600">{t('karachi_address_line3', 'Karachi, Pakistan')}</p>
                        <p className="text-gray-600 mt-4">
                          {t('karachi_phone', 'Phone: +92 21 111-111-111')}<br />
                          {t('karachi_email', 'Email: info@gmpol.com')}
                        </p>
                      </div>
                    </div>
                  </div>
                  <div className="flex items-start">
                    ...
                    <div className="ml-4">
                      <h3 className="text-lg font-medium text-gray-900">
                        {t('usa_office', 'USA Office')}
                      </h3>
                      <p className="text-gray-600">{t('usa_address_line1', '1047 Dutch Mill Drive')}</p>
                      <p className="text-gray-600">{t('usa_address_line2', 'Ballwin, Missouri')}</p>
                      <p className="text-gray-600">{t('usa_address_line3', 'USA 63011')}</p>
                    </div>
                  </div>
                  <div className="flex items-start">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="text-gray-600">{t('main_phone', '03362143469')}</p>
                    </div>
                  </div>
                  <div className="flex items-start">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="text-gray-600">{t('main_email', 'info@gmpol.com')}</p>
                    </div>
                  </div>
                  <div className="flex items-start">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="text-gray-600">
                        {t('business_hours_weekdays', 'Monday - Saturday: 9:00 AM - 6:00 PM')}
                      </p>
                      <p className="text-gray-600">{t('sunday_closed', 'Sunday: Closed')}</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                <div className="bg-gray-100 rounded-lg overflow-hidden h-[250px] relative">
                  <iframe 
                    title={t('gmpol_karachi_location', 'GMPOL Karachi Location')} 
                ...
                <div className="bg-gray-100 rounded-lg overflow-hidden h-[250px] relative">
                  <iframe 
                    title={t('gmpol_usa_location', 'GMPOL USA Location')} 
